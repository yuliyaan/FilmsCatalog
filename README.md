...
Необходимо клонировать текущий репозиторий и доработать приложение. В качестве результата работы необходимо прислать ссылку на Ваш git-репозиторий с проектом на адрес a.aleksandrova@junior-projects.com. Исходные файлы в архиве присылать не нужно. Fork репозитория делать не нужно. Если не получается запустить проект из репозитория или есть какие-то вопросы по заданию, напишите на a.aleksandrova@junior-projects.com. 
